...
function Clock() {
    ...
    const stringDate = new Intl.DateTimeFormat(["en-us"]).format()



    // день недели на английском, месяц на английском (https://learn.javascript.ru/intl#intl-datetimeformat)
    const stringDay = date.toLocaleString("en-us", { weekday: "long" }) || <br/> // пишут студенты
    const stringMonth = date.toLocaleString("en-us", { month: "long" }) || <br/> // пишут студенты 'date->month'
    ...
    return (
        <div className={s.clock}>
            ...
            <div className={s.buttonsContainer}>
                <SuperButton
                    id={'hw9-button-start'}
                    disabled={isSetInterval} // пишут студенты // задизэйблить если таймер запущен
                    onClick={start}
                >
                    start
                </SuperButton>
                <SuperButton
                    id={'hw9-button-stop'}
                    disabled={!isSetInterval} // пишут студенты // задизэйблить если таймер не запущен
                    onClick={stop}
                >
                    stop
                </SuperButton>
